...
public class RecyclerViewOnScroll extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            int firstItemVisible = gridLayoutManager.findFirstVisibleItemPosition();
            int lastItemVisible = gridLayoutManager.findLastVisibleItemPosition();
            mPullLoadMoreRecyclerView.onItemVisibleRangedChanged(firstItemVisible, lastItemVisible);
