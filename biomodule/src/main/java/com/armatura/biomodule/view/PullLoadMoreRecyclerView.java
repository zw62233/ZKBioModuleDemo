...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        View view = LayoutInflater.from(context).inflate(R.layout.pull_loadmore_layout, this, false);
    ...
    public void onItemVisibleRangedChanged(int start,int end){
        if (mPullLoadMoreListener != null) {
            mPullLoadMoreListener.onItemVisibleRangeChanged(start, end);
        }
    }
    ...
    public interface PullLoadMoreListener {
        ...
        void onItemVisibleRangeChanged(int start,int end);
    }
}
