...
import com.armatura.biomodule.databinding.FragmentFace1v1ByUvcBinding
...
import com.armatura.biomodule.viewmodel.Face1V1ViewModel
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.flow.flowOn
import kotlinx.coroutines.launch

class Face1V1Fragment : BaseFragment(), SurfaceHolder.Callback {
    ...
    private lateinit var binding: FragmentFace1v1ByUvcBinding

    private val face1V1ViewModel by viewModels<Face1V1ViewModel>()
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_face_1v1_by_uvc, container, false)
        return binding.root
    }
    ...
    private fun initView() {
        ...
        binding.registerProgressBar.max = 200
        binding.btnExtractFace1.setOnClickListener {
            ...
            face1V1ViewModel.extractFace().flowOn(Dispatchers.IO)
                .safeCollect(lifecycle, lifecycleScope) {
                    with(binding) {
                        registerStatusTv.text = it.message
                        registerProgressBar.progress = it.result!!
    ...
    companion object {
        ...
        fun newInstance(title: String?): Face1V1Fragment {
            val fragment = Face1V1Fragment()
            val bundle = Bundle()
